...
public class FriendListScreen extends JFrame implements ActionListener {
	...
	public FriendListScreen() {
		...
		JLabel lblNewJgoodiesLabel_12 = DefaultComponentFactory.getInstance().createLabel("My Friend");
		...
		JLabel lblNewJgoodiesLabel_13 = DefaultComponentFactory.getInstance().createLabel("Friend (50)");
		...
		JButton btnNewButton_5 = new JButton("UNFRIEND");
		...
		JButton btnNewButton_7 = new JButton("UNFRIEND");
